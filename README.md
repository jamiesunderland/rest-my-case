...
| get<T> | (uri: string, query?: string \| {}) => [ResponseType<T>](https://github.com/jamiesunderland/rest-my-case/blob/master/src/interfaces/HttpResponse.ts) | A regular get request. The first argument is the uri path (excluding the uriPrefix if set). The second optional argument is a query string or object, which will if an object the keys will be serialized in your server case. If the query parameter is a string, the query parameters will not be serialized into server case. T denotes the type of the successful response that is resolved if used in typescript. |
| post<T> | (uri: string, param: {}) => [ResponseType<T>](https://github.com/jamiesunderland/rest-my-case/blob/master/src/interfaces/HttpResponse.ts) | A regular post request. The first argument is the uri path (excluding the uriPrefix if set). The second argument is the data to be serialzed in the request. T denotes the type of the successful response that is resolved if used in typescript. |
| put<T> | (uri: string, query?: param: {}) => [ResponseType<T>](https://github.com/jamiesunderland/rest-my-case/blob/master/src/interfaces/HttpResponse.ts) | A regular put request. The first argument is the uri path (excluding the uriPrefix if set). The second argument is the data to be serialzed in the request. T denotes the type of the successful response that is resolved if used in typescript. |
| patch<T> | (uri: string, param: {}) => [ResponseType<T>](https://github.com/jamiesunderland/rest-my-case/blob/master/src/interfaces/HttpResponse.ts) | A regular patch request. The first argument is the uri path (excluding the uriPrefix if set). The second argument is the data to be serialzed in the request. T denotes the type of the successful response that is resolved if used in typescript. |
| delete<T> | (uri: string, param: {}) => [ResponseType<T>](https://github.com/jamiesunderland/rest-my-case/blob/master/src/interfaces/HttpResponse.ts) | A regular delete request. The first argument is the uri path (excluding the uriPrefix if set). The second argument is the data to be serialzed in the request. T denotes the type of the successful response that is resolved if used in typescript. |
| options<T> | (uri: string, param: {}) => [ResponseType<T>](https://github.com/jamiesunderland/rest-my-case/blob/master/src/interfaces/HttpResponse.ts) | An options request. The first argument is the uri path (excluding the uriPrefix if set). The second argument is the data to be serialzed in the request. T denotes the type of the successful response that is resolved if used in typescript. Note: Untested, use at your own discretion! |
| head<T> | (uri: string, param: {}) => [ResponseType<T>](https://github.com/jamiesunderland/rest-my-case/blob/master/src/interfaces/HttpResponse.ts) | A head request. The first argument is the uri path (excluding the uriPrefix if set). The second argument is the data to be serialzed in the request. T denotes the type of the successful response that is resolved if used in typescript. Note: Untested, use at your own discretion! |
| trace<T> | (uri: string, param: {}) => [ResponseType<T>](https://github.com/jamiesunderland/rest-my-case/blob/master/src/interfaces/HttpResponse.ts) | A trace request. The first argument is the uri path (excluding the uriPrefix if set). The second argument is the data to be serialzed in the request. T denotes the type of the successful response that is resolved if used in typescript. Note: Untested, use at your own discretion! |
| connect<T> | (uri: string, param: {}) => [ResponseType<T>](https://github.com/jamiesunderland/rest-my-case/blob/master/src/interfaces/HttpResponse.ts) | A connect request. The first argument is the uri path (excluding the uriPrefix if set). The second argument is the data to be serialzed in the request. T denotes the type of the successful response that is resolved if used in typescript. Note: Untested, use at your own discretion! |
| request<T> | (method: [HttpMethod](https://github.com/jamiesunderland/rest-my-case/blob/master/src/HttpMethod.ts), uri: string, param: {}) => [ResponseType<T>](https://github.com/jamiesunderland/rest-my-case/blob/master/src/interfaces/HttpResponse.ts) | A raw request method. You should not need to use this but if you prefer manually inserting the http method instead of using one of the rest methods provided to the RmcClient this is the method to call. T denotes the type of the successful response that is resolved if used in typescript.|
